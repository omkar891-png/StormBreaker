...
;
const metadata = {
    title: "Smart Attendance System - Face Recognition & ID Verification",
    description: "Secure campus attendance tracking with face recognition and ID card verification. Anti-proxy, real-time, tamper-proof.",
    generator: "v0.app"
};
